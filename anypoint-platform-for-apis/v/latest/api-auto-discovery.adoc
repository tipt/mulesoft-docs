...
[NOTE]
--
In Mule 3.8 Runtime and older, API Gateway is unified into the runtime. +
References to API gateway configurations are kept as a support for older versions.
--
...
....
[tab,title="Latest API Gateway versions"]
....
...
....
[tab,title="Older API Gateway Versions"]
....
