...
*** Implementing a
**** link:/anypoint-platform-for-apis/apikit-tutorial#creating-a-new-project[REST]
**** link:/anypoint-platform-for-apis/apikit-for-soap#creating-a-new-project[SOAP]
**** link:/anypoint-platform-for-apis/creating-an-odata-api-with-apikit#installing-and-using-the-apikit-odata-extension[OData API]
