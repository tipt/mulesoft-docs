...
* When configuring the link:/mule-user-guide/v/3.8-m1/endpoint-configuration-reference#redelivery-policy[*Idempotent Redelivery Policy*] of a custom endpoint.

* When configuring an link:/mule-user-guide/v/3.8-m1/routers[Aggregator], you can either use the two default built-in object stores or createa and reference your own.
