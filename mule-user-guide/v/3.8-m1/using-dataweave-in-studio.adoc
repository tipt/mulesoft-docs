...
* link:/mule-user-guide/v/3.8-m1/dataweave-formats#csv[CSV]

* link:/mule-user-guide/v/3.8-m1/dataweave-formats#xml[XML]

* link:/mule-user-guide/v/3.8-m1/dataweave-formats#flat-file[Flat File]
...
* link:/mule-user-guide/v/3.8-m1/dataweave-formats#json[JSON]
