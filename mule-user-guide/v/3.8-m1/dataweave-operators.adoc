...
Removes an set of elements from an array, all in one operation when an element in the base array matches one of the values in the substracted array. If multiple elements in the array match a value, they will all be removed.
...
Rounds the value of the number to the nearest integer
...
Returns the smallest following number
...
Returns the largest previous number
